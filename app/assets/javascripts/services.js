angular
  ...
  .factory("Application", [
    ...
    "states",
    "$location",
    function ($http, $log, relationshipCodes, states, $location) {
      applicant_ids = 0;
      ...
      IncomeTaxes.prototype.fields = [
        ...
        {
          app: "taxableRefunds",
          api: "Taxable Refunds, Credits, or Offsets of State and Local Income Taxes",
        },
      ...
      TaxReturn.prototype.canAddFiler = function (application) {
        return (
          this.filers.length < 2 &&
          this.filers.length < application.applicants.length
        );
      };
      ...
      TaxReturn.prototype.canAddDependent = function (application) {
        return (
          ...
          this.dependents.length < application.applicants.length - 1
        );
      };
      ...
      Application.prototype.cleanHouseholds = function () {
        var idx = _.map(this.households, function (hh) {
          return hh.length;
        }).indexOf(0);
      ...
      Applicant.prototype.fields = [
        ...
        {
          app: "disabled",
          api: "Applicant Attest Blind or Disabled",
          type: "checkbox",
        },
        { app: "student", api: "Student Indicator", type: "checkbox" },
        {
          app: "eligible",
          api: "Medicare Entitlement Indicator",
          type: "checkbox",
        },
        { app: "incarcerated", api: "Incarceration Status", type: "checkbox" },
        { app: "livesInState", api: "Lives In State", type: "checkbox" },
        {
          app: "claimedByNonApplicant",
          api: "Claimed as Dependent by Person Not on Application",
          type: "checkbox",
        },
        {
          app: "longTermCare",
          api: "Applicant Attest Long Term Care",
          type: "checkbox",
        },
        { app: "hasInsurance", api: "Has Insurance", type: "checkbox" },
        {
          app: "stateEmployeeHealthBenefits",
          api: "State Health Benefits Through Public Employee",
          type: "checkbox",
        },
        {
          app: "priorInsuranceIndicator",
          api: "Prior Insurance",
          type: "checkbox",
        },
        {
          app: "pregnant",
          api: "Applicant Pregnant Indicator",
          type: "checkbox",
        },
        {
          app: "pregnantThreeMonths",
          api: "Applicant Postpartum Period Indicator",
          type: "checkbox",
        },
        {
          app: "formerlyFosterCare",
          api: "Former Foster Care",
          type: "checkbox",
        },
        {
          app: "incomeTaxesRequired",
          api: "Required to File Taxes",
          type: "checkbox",
        },
      ...
      Applicant.prototype.residencyFields = [
        {
          app: "temporarilyOutOfState",
          api: "Temporarily Out of State",
          type: "checkbox",
        },
      ...
      Applicant.prototype.claimedFields = [
        {
          app: "claimerIsOutOfState",
          api: "Claimer Is Out of State",
          type: "checkbox",
        },
      ];
      ...
      Applicant.prototype.pregnantFields = [
        {
          app: "numberOfChildrenExpected",
          api: "Number of Children Expected",
          type: "string",
        },
      ];
      ...
      Applicant.prototype.fosterCareFields = [
        {
          app: "hadMedicaid",
          api: "Had Medicaid During Foster Care",
          type: "checkbox",
        },
        {
          app: "ageLeftFosterCare",
          api: "Age Left Foster Care",
          type: "string",
        },
      ...
      Applicant.prototype.lawfulPresentFields = [
        {
          app: "immigrationStatus",
          api: "Immigration Status",
          type: "immigrationStatus",
        },
        {
          app: "refugeeMedicalAssistanceEligible",
          api: "Refugee Status",
          type: "checkbox",
        },
      ];
      ...
      Applicant.prototype.qualifiedNonCitizenFields = [
        ...
        {
          app: "humanTraffickingVictim",
          api: "Victim of Trafficking",
          type: "checkbox",
        },
        {
          app: "sevenYearStartDate",
          api: "Seven Year Limit Start Date",
          type: "date",
        },
        ...
        {
          app: "fortyQuarters",
          api: "Applicant Has 40 Title II Work Quarters",
          type: "checkbox",
        },
      ];
      ...
      Applicant.prototype.refugeeMedicalAssistanceFields = [
        {
          app: "startDate",
          api: "Refugee Medical Assistance Start Date",
          type: "date",
        },
      ];
      ...
      Applicant.prototype.serialize = function () {
        ...
        if (!this.livesInState) {
          rv = rv.concat(
            _.map(this.residencyFields, function (field) {
              return serializeField(field, me);
            })
          );
        }
        ...
        if (this.claimedByNonApplicant) {
          rv = rv.concat(
            _.map(this.claimedFields, function (field) {
              return serializeField(field, me);
            })
          );
        }
        ...
        if (this.priorInsuranceIndicator) {
          rv = rv.concat(
            _.map(this.priorInsuranceFields, function (field) {
        ...
        if (this.pregnant) {
          rv = rv.concat(
            _.map(this.pregnantFields, function (field) {
              return serializeField(field, me);
            })
          );
        }
        ...
        if (this.formerlyFosterCare) {
          rv = rv.concat(
            _.map(this.fosterCareFields, function (field) {
        ...
        if (!this.citizen) {
          ...
          if (this.nonCitizen.lawful) {
            ncOut = ncOut.concat(
              _.map(this.lawfulPresentFields, function (field) {
                return serializeField(field, me.lawful);
              })
            );
            if (this.lawful.immigrationStatus.qnc) {
              ncOut = ncOut.concat(
                _.map(this.qualifiedNonCitizenFields, function (field) {
            ...
            if (this.lawful.refugeeMedicalAssistanceEligible) {
              ncOut = ncOut.concat(
                _.map(this.refugeeMedicalAssistanceFields, function (field) {
        ...
        rv.push([
          "Relationships",
          _.map(this.relationships, function (rel) {
      ...
      Applicant.prototype.deserialize = function (person, idx) {
        ...
        angular.forEach(this.refugeeMedicalAssistanceFields, function (field) {
          me.refugeeMedicalAssistance[field.app] = deserializeField(
            field,
            person
          );
        });
      ...
      Relationship.prototype.serialize = function () {
        return {
          ...
          "Attest Primary Responsibility": this.primaryResponsibility
            ? "Y"
            : "N",
        };
      };
      ...
      TaxReturn.prototype.serialize = function () {
        return {
          Filers: _.chain(this.filers)
            .filter(function (pers) {
              return pers && pers.uid;
            })
            .map(function (pers) {
              return { "Person ID": pers.uid };
            })
            .value(),
          Dependents: _.chain(this.dependents)
            .filter(function (pers) {
              return pers.uid;
            })
            .map(function (pers) {
      ...
      Application.prototype.serialize = function () {
        ...
        return {
          ...
          People: _.map(this.applicants, function (applicant) {
            return applicant.serialize();
          }),
          ...
          "Tax Returns": _.map(this.taxReturns, function (tr) {
            return tr.serialize();
          }),
        };
      };
      ...
      Application.prototype.deserialize = function (application) {
        ...
        this.taxReturns = _.map(
          application["Tax Returns"],
          function (taxReturn) {
        ...
        this.households = _.map(
          application["Physical Households"],
          function (hh) {
        ...
        angular.forEach(application["People"], function (person) {
          ...
          pers.relationships = _.map(person["Relationships"], function (rel) {
            return new Relationship(
              pers,
              me.getApplicantByRawId(rel["Other ID"]),
              rel["Relationship Code"],
              rel["Attest Primary Responsibility"] == "Y"
            );
          });
        });
      ...
      Application.prototype.checkEligibility = function () {
        ...
        return $http({
          ...
          .success(function (response) {
            ...
            angular.forEach(
              me.determination["Applicants"],
              function (applicant) {
                applicant.cleanDets = _.map(
                  _.pairs(applicant.Determinations),
                  function (item) {
                    ...
                    if (me.state.abbr == "ND") {
                      if (
                        item[0] == "Medicaid Citizen Or Immigrant" &&
                        applicant["Medicaid Category"] == "None"
                      ) {
                        hide = true;
                      } else if (
                        item[0] == "CHIP Citizen Or Immigrant" &&
                        (applicant["CHIP Category"] == "None" ||
                          applicant["Medicaid Eligible"] == "Y")
                      ) {
                        hide = true;
                      }
                    }
  ...
  .constant("applicationStatuses", [
    {
      code: "01",
      name: "Lawful Permanent Resident (LPR/Green Card Holder)",
      qnc: true,
    ...
    { code: "03", name: "Refugee", qnc: true, startDate: "Refugee admit date" },
    {
      ...
      qnc: true,
      startDate: "Status grant date",
    },
    {
      code: "05",
      name: "Paroled into the U.S. for at least one year",
      qnc: true,
    },
    { code: "06", name: "Conditional entrant granted before 1980", qnc: true },
    {
      code: "07",
      name: "Battered non-citizen, spouse, child, or parent",
      qnc: true,
    },
    { code: "08", name: "Victim of trafficking", qnc: true },
    {
      code: "09",
      name: "Granted withholding of deportation",
      qnc: true,
      startDate: "Deportation withheld date",
    },
    {
      code: "10",
      name: "Member of a federally recognized Indian tribe or American Indian born in Canada",
      qnc: true,
    },
